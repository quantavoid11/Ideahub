                ...
                <div >
                    <nav className="flex  justify-between py-4 px-3 gap-x-2">
                        ...
                        <div className="flex  gap-x-2">
                            <div
                                className=" flex items-center justify-center px-2 hover:underline hover:bg-gray-100 hover:rounded-lg">
                            ...
                            <div className="flex gap-x-2">
                                ...
                                <Button asChild className="bg-blue-700 h-10  text-[18px] font-normal hover:bg-blue-800 px-3">
